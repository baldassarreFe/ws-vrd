...
def add_hparam_summary(writer: SummaryWriter, hparams: OmegaConf):
    hparam_infos = []
...
def add_session_start(writer: SummaryWriter, hparams: OmegaConf):
    hparam_values = {}
    ...
    session_summary = make_session_start_summary(hparam_values)
